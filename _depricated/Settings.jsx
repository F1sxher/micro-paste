...
const HOST_OPTIONS = [
  ...
  { label: "{{username}}-is.a-shitty.dev", jsx: <p>username-is.a-shitty.dev</p>, set: "isd" },
  { label: "{{username}}.is-a-femboy.com", jsx: <p>username.is-a-femboy.com</p>, set: "ifb" },
  { label: "{{username}}.is-fucking.gay", jsx: <p>{username}.is-fucking.gay</p>, set: "ifg" },
  { label: "{{username}}.likes-to.party", jsx: <p>{username}.likes-to.party</p>, set: "ltp" },
  { label: "{{username}}.is-dumb-as.rocks", jsx: <p>{username}.is-dumb-as.rocks</p>, set: "dar" },
  { label: "{{username}}.hates-this.place", jsx: <p>{username}.hates-this.place</p>, set: "htp" },
    ...
    <Category 
      ...
      onChange={() => opened = !opened}>
        ...
        <TextInput
          ...
          required={false}
          onChange={val => updateSetting('hostUName', val)}
        >
          Host Username
        </TextInput>
